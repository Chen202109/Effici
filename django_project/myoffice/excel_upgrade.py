...
# 因此拼接好的字段英文名，数据列表
def upgrade_inster_sql(filePath):
    # excel的字段标题和 表的字段 对照关系
    name_field = {
        '升级资源池':'resourcepool','资源池':'resourcepoolversion','业务影响范围':'affectedarea','是否紧急升级':'isurgent',
        '微服务名称':'microservicename','升级内容':'upgradecontent','数据库升级':'isupgradedatabase',
        '升级类型':'upgradetype','问题类型':'questiontype',
        'JAIR任务号': 'jiracode', '升级内容':'upgradecontent','研发升级提交/执行人':'participants',
        '计划升级时间': 'plandate', '实际升级时间': 'realdate','是否解决': 'issolve','是否完成升级':'isended'
    }
