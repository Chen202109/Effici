<template>
    <div>
        ...
        <div class="saasThirdPartyProblemProvinceChart" id="saasThirdPartyProblemProvinceChart"
...
export default {
    ...
    methods: {
         ...
         */
        async saasThirdPartyProblemProvince(searchValue) {
            try {
                ...
                this.saasThirdPartyProblemProvinceChartData = response.data.data
                this.updateBarChartBasic(this.saasThirdPartyProblemProvinceChartData, '省份生产监控异常统计', "category", false, 'saasThirdPartyProblemProvinceChart')
                console.log('update local saasThirdPartyProblemProvinceChart data: ', this.saasThirdPartyProblemProvinceChartData)
